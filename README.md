...
A bit of inception-meta-commentary, while this course teaches about LLMs, I am also using LLMs in different capacities. For transparency, this is where I have used GPT or Claude for the construction of the course (I will update this list if/when is grows):
  1. I have LLMs annotate my code: I do not like annotating code and I am not particularly good at it. I let LLMs do that, especially at the beginning of the course.
