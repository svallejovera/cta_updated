...
## Project Components {.unnumbered}

The project has three parts:

  1. a *2-page project proposal* (to be discussed with, and approved by, me),
  2. an *in-class presentation*, and
  3. a *4000-word essay*.

You can find the deadlines and grading breakdown in the following table:
