...
5. Label a sample of your data (N=200); decide how you will sample the data and explain your decision. Have a LLM label the same sample (you can find the code [here](https://colab.research.google.com/drive/1CKdSOzV8ddcz9k4Z96t9vvHW_MjB6qTp?usp=sharing)). Estimate [inter-coder reliability](http://www.cookbook-r.com/Statistical_analysis/Inter-rater_reliability/) and [evaluate the results](https://statisticsbyjim.com/hypothesis-testing/inter-rater-reliability/).
